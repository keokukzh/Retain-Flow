...
export default function Footer() {
  ...
  const socialLinks = [
    {
      name: 'Discord',
      href: 'https://discord.gg/retainflow',
      icon: (
    ...
    {
      name: 'Twitter',
      href: 'https://twitter.com/retainflow',
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: 'LinkedIn',
      href: 'https://linkedin.com/company/retainflow',
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: 'GitHub',
      href: 'https://github.com/retainflow',
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
            ...
            <div className="flex items-center space-x-3 mb-6 group">
              <div className="relative w-12 h-12 flex items-center justify-center">
                <img
                  ...
                  style={{
                    filter: 'brightness(0) saturate(100%) invert(100%) sepia(100%) saturate(2000%) hue-rotate(200deg) brightness(1.2) contrast(1.2)'
                  }}
                />
              ...
              <span className="text-xl font-bold">RetainFlow</span>
            </div>
            <p className="text-gray-400 mb-6 max-w-md">
              AI-powered retention tools designed specifically for creators and community builders. 
              Reduce churn, increase engagement, and grow your community with intelligent automation.
            </p>
        ...
        <div className="mt-12 pt-8 border-t border-gray-800 flex flex-col md:flex-row justify-between items-center">
          <div className="text-gray-400 text-sm">
            © {currentYear} AIDevelopment. All rights reserved.
          </div>
